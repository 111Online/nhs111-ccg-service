...
namespace NHS111.Business.CCG.Tests
{
    ...
    public class CCGServiceTests
    {
        ...
        public async Task Get_Details_WithExistingPostcode_ReturnsCCGExtendedDetails()
        {
            ...
            _mockstpRepo.Setup(x => x.Get(It.IsAny<string>(), It.IsAny<string>())).Returns(Task.FromResult(stpEntity));
        ...
        private STPEntity SetupMockSTPRepoResult()
        {
            ...
            _mockstpRepo.Setup(r => r.Get(It.IsAny<string>(), It.IsAny<string>())).Returns(Task.FromResult(stpRepoResult));
